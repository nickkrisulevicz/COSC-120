...
int main()
{
	...
	while (moreInput == 'y' || moreInput == 'Y')
	{
		...
		float finalgrade = findGradeAvg(grades, numOfGrades);

		cout << finalgrade;// Fill in code to get and print average of student to screen

		cout << " which gives them a letter grade of " << findLetterGrade(finalgrade);// Fill in call to get and print letter grade of student to screen
...
char findLetterGrade(float numGrade)
{
	...
	else if(numGrade >= 80 && numGrade < 89.9)
    {
        letter = 'B';
    }
    else if(numGrade >= 70 && numGrade < 79.9)
    {
        letter = 'C';
    }
    else if(numGrade >= 60 && numGrade < 69.9)
    {
        letter = 'D';
    }
    else
